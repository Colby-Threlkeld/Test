...
export function HomeFeed() {
  ...
  return (
    <div className="mx-auto max-w-xl px-4 pt-4 pb-6">
      {/* Compose bar */}
      <div className="mb-4 flex items-center gap-3 rounded-xl border border-slate-700/40 bg-[#12121a] p-3 shadow-card">
        <Avatar src={user?.image} name={user?.name ?? ""} size="sm" />
        <button
          className="flex-1 rounded-lg bg-white/5 px-3 py-2 text-left text-sm text-slate-500 hover:bg-white/8 transition-colors"
      ...
      {/* Tabs */}
      <div className="mb-4 flex gap-1 rounded-lg border border-slate-700/40 bg-[#12121a] p-1 shadow-card">
      ...
      {loading ? (
        <div className="space-y-3">
          {[1, 2, 3].map((n) => (
            <div key={n} className="h-32 rounded-xl bg-white/5 animate-pulse" />
          ))}
        </div>
      ) : (
        <div className="space-y-3">
            ...
            nearbyLoading ? (
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-2">
                  ...
                  <span className="rounded-full bg-brand-600/15 px-2 py-0.5 text-[10px] font-semibold text-brand-400">
                    Near you
                  </span>
